...
| 파일 | 용도 |
|------|------|
| `/specs/<feature-name>.md` | 구현할 기능의 상세 명세 |
| `/context/project.md` | 기술 스택 가이드, 코딩 원칙 |
...
- `/output/<feature-name>/` — 기능별 코드 파일
- `/output/questions.md` — 역질문 항목 추가 (해당 시)
