  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <textarea
        ...
        className="min-h-[180px] w-full resize-none rounded-sm border border-border bg-surface px-3.5 py-3 text-[15px] leading-relaxed text-foreground outline-none placeholder:text-gray-3 focus:border-primary"
