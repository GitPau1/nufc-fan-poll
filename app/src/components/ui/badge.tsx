...
const badgeVariants = cva(
  "inline-flex items-center rounded-pill border px-[9px] py-[3px] text-[11px] font-semibold leading-none transition-opacity hover:opacity-70 focus:outline-none focus:ring-2 focus:ring-ring",
  {
    variants: {
      variant: {
        default:
