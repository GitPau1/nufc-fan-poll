-- Revalidate cached player pages after the weekly Pick One batch succeeds.

CREATE EXTENSION IF NOT EXISTS pg_net;

CREATE TABLE IF NOT EXISTS public.player_pick_one_revalidation_config (
...
ALTER TABLE public.player_pick_one_revalidation_config ENABLE ROW LEVEL SECURITY;
